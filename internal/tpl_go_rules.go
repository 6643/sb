...
func (g *GoGenerator) getGoLogicType(t TplType) string {
	if t.Name == "nil" {
		return ""
	}
...
func (g *GoGenerator) getGoRpcType(t TplType) string {
	if t.Name == "nil" {
		return ""
	}
	if t.IsList {
...
func (g *GoGenerator) getGoType(t TplType) string {
	if t.Name == "nil" {
		return ""
	}
...
func (g *GoGenerator) getGoTag(field TplStructField) string {
	if g.Config.GoTag == "" {
		return ""
	}
